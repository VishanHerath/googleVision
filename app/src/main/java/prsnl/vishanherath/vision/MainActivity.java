...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView image;
    Button importBtn, detectbtn, secondActBtn, thirdActBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thirdActBtn = findViewById(R.id.thirdActBtn);

        secondActBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent scnd = new Intent(getApplicationContext(), SecondActivity.class);
                startActivity(scnd);
            }
        });
        ...
        thirdActBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent thrd = new Intent(getApplicationContext(), ThirdActivity.class);
                startActivity(thrd);
            }
        });
    ...
    //TODO this shit doesnt work bbi
    private void check(){
